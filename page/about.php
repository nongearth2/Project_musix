...
<body>
    ...
    <section class="about-section">
        <div class="container about-content">
            <h1 class="about-title"><i class="fa-solid fa-headphones"></i> เกี่ยวกับเรา</h1>
            <p class="about-text">
                เว็บไซต์ผ่อนคลายโดยใช้เสียงบำบัดนี้ได้รับการพัฒนาให้มีระบบที่ตอบสนองความต้องการของผู้ใช้ได้อย่างครอบคลุม
                ทั้งในด้านการฟังเสียงบำบัดทั่วไป การเพิ่มเสียงที่มีคุณภาพสูงขึ้นสำหรับผู้ใช้ Premium
                และระบบการจัดการเสียงที่ผู้ดูแลระบบสามารถควบคุมได้
                โดยเว็บไซต์นี้ได้แก้ปัญหาสำคัญของผู้ใช้ที่ต้องการเสียงบำบัดที่เหมาะสมกับตนเอง
                และช่วยให้ผู้ใช้สามารถเข้าถึงเสียงที่ต้องการได้อย่างสะดวกและรวดเร็ว
            </p>
            <p class="about-text">
                เสียงทั้งหมดในเว็บไซต์นี้นำมาจาก <strong>Pixabay.com</strong> และอยู่ภายใต้สัญญาอนุญาต <strong>CC0
                    (Creative Commons Zero)</strong>
                ซึ่งช่วยให้สามารถใช้งานได้อย่างอิสระโดยไม่มีข้อจำกัดด้านลิขสิทธิ์
            </p>
        </div>
    </section>
    <?php
